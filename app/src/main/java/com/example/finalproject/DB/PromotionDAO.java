...
import com.example.finalproject.Models.Promotion;
...
public class PromotionDAO {
    ...
    public static void addPromotion(Promotion promotion, SQLiteDatabase db) {
        ...
        values.put(COLUMN_REASON, promotion.getReason());
    ...
    public static ArrayList<Promotion> getAllPromotions(SQLiteDatabase db) {
        ...
        String[] columns = {COLUMN_ID, COLUMN_START_DATE, COLUMN_END_DATE, COLUMN_VALUE, COLUMN_REASON};
